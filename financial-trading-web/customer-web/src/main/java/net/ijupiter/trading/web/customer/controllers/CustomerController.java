...
public class CustomerController extends BaseController {
    ...
    @ResponseBody
    @PreAuthorize("hasAuthority('customer:account:view')")
    public Result<List<TradingAccountBasicInfoDTO>> getTradingAccountList(@PathVariable String customerId) {
        try {
            List<TradingAccountBasicInfoDTO> accounts = customerService.getTradingAccountBasicInfoByCustomerId(customerId);
    ...
    @ResponseBody
    @PreAuthorize("hasAuthority('customer:account:view')")
    public Result<TradingAccountBasicInfoDTO> getTradingAccountDetail(@PathVariable String id) {
        try {
            Optional<TradingAccountBasicInfoDTO> account = customerService.getTradingAccountBasicInfoById(id);
    ...
    @ResponseBody
    @PreAuthorize("hasAuthority('customer:account:view')")
    public Result<List<FundAccountBasicInfoDTO>> getFundAccountList(@PathVariable String customerId) {
        try {
            List<FundAccountBasicInfoDTO> accounts = customerService.getFundAccountBasicInfoByCustomerId(customerId);
            return Result.success(accounts);
        } catch (Exception e) {
    ...
    @ResponseBody
    @PreAuthorize("hasAuthority('customer:account:view')")
    public Result<FundAccountBasicInfoDTO> getFundAccountDetail(@PathVariable String id) {
        try {
            Optional<FundAccountBasicInfoDTO> account = customerService.getFundAccountBasicInfoById(id);
            return account.map(Result::success)
