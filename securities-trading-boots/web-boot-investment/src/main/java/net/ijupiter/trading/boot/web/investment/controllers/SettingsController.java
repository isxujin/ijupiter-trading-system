...
public class SettingsController extends InvestmentBaseController {

    @Value("${investment.terminal.title:金融交易系统投资平台}")
    ...
    public String settings(Model model) {
        ...
        // 其他业务逻辑保持不变
        return "investment/settings"; // 对应 templates/investment/settings.html 模板
    }
