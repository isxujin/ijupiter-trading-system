...
public interface CustomerService {
     ...
     * @return 交易账户基本信息
     */
    Optional<TradingAccountBasicInfoDTO> getTradingAccountBasicInfoById(String accountId);
     ...
     * @return 交易账户基本信息列表
     */
    List<TradingAccountBasicInfoDTO> getTradingAccountBasicInfoByCustomerId(String customerId);
     ...
     * @return 资金账户基本信息
     */
    Optional<FundAccountBasicInfoDTO> getFundAccountBasicInfoById(String accountId);
     ...
     * @return 资金账户基本信息列表
     */
    List<FundAccountBasicInfoDTO> getFundAccountBasicInfoByCustomerId(String customerId);
