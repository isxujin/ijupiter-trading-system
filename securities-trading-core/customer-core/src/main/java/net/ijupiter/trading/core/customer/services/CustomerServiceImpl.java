...
import net.ijupiter.trading.core.customer.entities.FundAccountEntity;
...
import net.ijupiter.trading.core.customer.repositories.FundAccountRepository;
import net.ijupiter.trading.core.customer.repositories.FundAccountBalanceRepository;
import net.ijupiter.trading.core.customer.repositories.TradingAccountRepository;
...
public class CustomerServiceImpl implements CustomerService {
    ...
    private final FundAccountRepository fundAccountBasicInfoRepository;
    private final FundAccountBalanceRepository fundAccountBalanceRepository;
    private final TradingAccountRepository tradingAccountBasicInfoRepository;
    ...
    public void closeTradingAccount(String accountId, String reason) {
        ...
        // 检查交易账户是否存在
        Optional<TradingAccountEntity> accountOptional = tradingAccountBasicInfoRepository.findByAccountId(accountId);
    ...
    @Override
    @Transactional(readOnly = true)
    public Optional<TradingAccountDTO> getTradingAccountBasicInfoById(String accountId) {
    ...
    @Override
    @Transactional(readOnly = true)
    public List<TradingAccountDTO> getTradingAccountBasicInfoByCustomerId(String customerId) {
    ...
    public void closeFundAccount(String accountId, String reason) {
        ...
        // 检查资金账户是否存在
        Optional<FundAccountEntity> accountOptional = fundAccountBasicInfoRepository.findByAccountId(accountId);
        if (!accountOptional.isPresent()) {
    ...
    @Override
    @Transactional(readOnly = true)
    public Optional<FundAccountDTO> getFundAccountBasicInfoById(String accountId) {
    ...
    @Override
    @Transactional(readOnly = true)
    public List<FundAccountDTO> getFundAccountBasicInfoByCustomerId(String customerId) {
